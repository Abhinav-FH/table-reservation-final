...
export const reservationApi = {
  ...
  createReservation: (payload: CreateReservationPayload) => {
    console.log('🔴 [reservationApi] createReservation payload:', JSON.stringify(payload, null, 2));
    return apiClient.post<ApiResponse<Reservation>>(Endpoints.myReservations, payload);
  },
